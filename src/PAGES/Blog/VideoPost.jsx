            ...
            <div>
                ...
                <section className='STANDARD-POST container mx-auto pt-[100px]'>
                    <div className='BIG-IMG mb-10 relative'>
                        <img className='w-full rounded-md' src="./src/assets/blog/video-post/asset 2.jpeg" alt="" />
                        <div className='absolute h-40 w-40 bg-black bg-opacity-80 hover:bg-opacity-100 duration-300 rounded-full top-0 left-0 right-0 bottom-0 m-auto'>
                            <a href="https://www.youtube.com/watch?v=L7mfjvdnPno" target='_blank'><i class="fa-solid fa-play h-40 w-40 text-4xl text-white flex justify-center items-center"></i></a>
                        </div>
                    </div>
                        ...
                        <div className='DETAILS col-span-6'>
                            <div>
                                ...
                                <div className='flex items-center mb-7 border-b py-10'>
                                    <img className='bg-cover w-12 mr-5 rounded-full' src="./src/assets/blog/video-post/asset 3.png" alt="" />
                                    <div>
                                ...
                                <div className='text-gray-500'>
                                    ...
                                    <div className='grid grid-cols-2 gap-10 mb-8'>
                                        <img className='rounded-lg' src="./src/assets/blog/video-post/asset 4.png" alt="" />
                                        <img className='rounded-lg' src="./src/assets/blog/video-post/asset 5.png" alt="" />
                                    </div>
                                ...
                                <div>
                                    ...
                                    <div>
                                        <div className='flex'>
                                            <img className='w-16 h-16' src="./src/assets/blog/video-post/asset 6.png" alt="" />
                                            <div className='ml-5'>
                                        ...
                                        <div className='flex'>
                                            <img className='w-16 h-16' src="./src/assets/blog/video-post/asset 7.png" alt="" />
                                            <div className='ml-5'>
                                ...
                                <div className='BOX-2 border p-8 rounded-md mt-14'>
                                    ...
                                    <div className='flex border-b border-gray-100 pb-5 '>
                                        <div className='rounded-lg overflow-hidden'>
                                            <img className='bg-cover rounded-lg  hover:scale-110 duration-500 cursor-pointer' src="./src/assets/blog/video-post/asset 11.jpeg" alt="" />
                                        </div>
                                    ...
                                    <div className='flex border-b border-gray-100 py-5 '>
                                        <div className='rounded-lg overflow-hidden'>
                                            <img className='bg-cover rounded-lg  hover:scale-110 duration-500 cursor-pointer' src="./src/assets/blog/video-post/asset 12.jpeg" alt="" />
                                        </div>
                                        <div className='ml-10 mt-3'>
                                    ...
                                    <div className='flex pt-5 '>
                                        <div className='rounded-lg overflow-hidden'>
                                            <img className='bg-cover rounded-lg  hover:scale-110 duration-500 cursor-pointer' src="./src/assets/blog/video-post/asset 13.jpeg" alt="" />
                                        </div>
                                        <div className='ml-10 mt-3'>
