                ...
                <section className='STANDARD-POST container mx-auto pt-[100px]'>
                    <div className='TOP-PART'>
                        <div className=' bg-[#F9F3F0] p-12 pb-16 rounded-md border-l-[6px] border-[#FAB8C4] '>
                            <div className='mb-7'>
                                <h1 className='text-[#292930] text-[45px] leading-snug italic font-semibold  duration-300 inline'>“An oral history of the AIM away message (by the people who were there)”</h1>
                            </div>
                        ...
                        <div className='DETAILS col-span-6'>
                            <div>
                                <div className='text-gray-500'>
                                    <p className='mb-8 '>Habitasse per feugiat aliquam luctus accumsan curae, suspendisse aliquam taciti eros neque, aenean sit iaculis risus commodo ut sociosqu rhoncus potenti tristique placerat sit tempus, duis erat feugiat cras sociosqu porta ut praesent, fermentum donec convallis tellus vulputate duis nibh rhoncus phasellus dui massa nisl.</p>
                                ...
                                <div className='text-gray-500'>
                                    ...
                                    <p className='mb-10'>To download hi-res images, click here.</p>
                                </div>
                                <div>
                                    <h1 className='text-[#292930] text-2xl font-bold mb-10'>2 comments</h1>
                                    <div>
                                        <div className='flex'>
                                            <img className='w-16 h-16' src="../src/assets/blog/quote-post/asset 3.png" alt="" />
                                            <div className='ml-5'>
                                        ...
                                        <div className='flex'>
                                            <img className='w-16 h-16' src="../src/assets/blog/quote-post/asset 4.png" alt="" />
                                            <div className='ml-5'>
                                                <h1 className='text-[#292930] text-lg font-semibold hover:text-[#3577F0] cursor-pointer duration-300 inline'>Thopmson Arnold</h1>
                                                <h1 className='text-gray-400 my-3'>Nov 23, 2018 at 12:23 pm <span className='text-[4px] align-middle'><i class="fa-solid fa-circle"></i></span><span className='font-semibold text-[#3577F0] ml-2 cursor-pointer'>Reply</span></h1>
                                                <p className='text-gray-500 mb-20'>Duis hendrerit velit scelerisque felis tempus, id porta libero venenatis. Nulla facilisi. Phasellus viverra magna commodo dui lacinia tempus. Donec malesuada nunc non dui posuere, fringilla vestibulum urna mollis. Integer condimentum ac sapien quis maximus.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
