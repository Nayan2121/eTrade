            ...
            <div>
                ...
                <section className='STANDARD-POST container mx-auto pt-[100px]'>
                    <div className='BIG-IMG relative group'>
                        <a href="#"><img className='rounded-lg w-full cursor-auto' src="./src/assets/blog/gallery-post/asset 3.jpeg" alt="" /></a>
                            ...
                            <div>
                                ...
                                <div className='text-gray-500'>
                                    ...
                                    <div className='grid grid-cols-2 gap-10 mb-8'>
                                        <img className='rounded-lg' src="./src/assets/blog/gallery-post/asset 5.png" alt="" />
                                        <img className='rounded-lg' src="./src/assets/blog/gallery-post/asset 6.png" alt="" />
                                    </div>
                                ...
                                <div>
                                    ...
                                    <div>
                                        <div className='flex'>
                                            <img className='w-16 h-16' src="./src/assets/blog/gallery-post/asset 7.png" alt="" />
                                            <div className='ml-5'>
                                        ...
                                        <div className='flex'>
                                            <img className='w-16 h-16' src="./src/assets/blog/gallery-post/asset 8.png" alt="" />
                                            <div className='ml-5'>
                                ...
                                <div className='BOX-2 border p-8 rounded-md mt-14'>
                                    ...
                                    <div className='flex border-b border-gray-100 pb-5 '>
                                        <div className='rounded-lg overflow-hidden'>
                                            <img className='bg-cover rounded-lg  hover:scale-110 duration-500 cursor-pointer' src="./src/assets/blog/gallery-post/asset 12.jpeg" alt="" />
                                        </div>
                                    ...
                                    <div className='flex border-b border-gray-100 py-5 '>
                                        <div className='rounded-lg overflow-hidden'>
                                            <img className='bg-cover rounded-lg  hover:scale-110 duration-500 cursor-pointer' src="./src/assets/blog/gallery-post/asset 13.jpeg" alt="" />
                                        </div>
                                        <div className='ml-10 mt-3'>
                                    ...
                                    <div className='flex pt-5 '>
                                        <div className='rounded-lg overflow-hidden'>
                                            <img className='bg-cover rounded-lg  hover:scale-110 duration-500 cursor-pointer' src="./src/assets/blog/gallery-post/asset 14.jpeg" alt="" />
                                        </div>
                                        <div className='ml-10 mt-3'>
